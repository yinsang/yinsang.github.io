!function() {
        ...
        v.forEach(function(h) {
            ...
            for (d = 0; d < c.length; d++) {
                ...
                if (h !== b && null !== b.x && null !== b.y) {
                    ...
                    e = h.y - b.y,
                    f = g * g + e * e;
                    f < b.max && (b === I && f >= b.max / 2 && (h.x -= 0.03 * g,
                    h.y -= 0.03 * e),
                    a = (b.max - f) / b.max,
                    J.beginPath(),
                    J.lineWidth = a / 2,
                    J.strokeStyle = "rgba(" + w.c + "," + (a + 0.2) + ")",
                    J.moveTo(h.x, h.y),
                    J.lineTo(b.x, b.y),
                    J.stroke())
                }
    ...
    var i = document.createElement("canvas"), w = D(), L = "c_n" + w.l, J = i.getContext("2d"), x, B, C = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(a) {
